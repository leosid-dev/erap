ops_dict = {
    "RV32": {
   	...
   	"Zve32x": {
            "loads": [
	            "vlm.v", "vle8.v", "vle16.v", "vle32.v",
        	    "vluxei8.v", "vluxei16.v", "vluxei32.v",
        	    "vlse8.v", "vlse16.v", "vlse32.v",
        	    "vloxei8.v", "vloxei16.v", "vloxei32.v",
        	    "vle8ff.v", "vle16ff.v", "vle32ff.v",
        	    "vl1re8.v", "vl1re16.v", "vl1re32.v",
        	    "vl2re8.v", "vl2re16.v", "vl2re32.v",
        	    "vl4re8.v", "vl4re16.v", "vl4re32.v",
        	    "vl8re8.v", "vl8re16.v", "vl8re32.v"
        ],
            "stores": [
          	    "vsm.v", "vse8.v", "vse16.v", "vse32.v",
	            "vsuxei8.v", "vsuxei16.v", "vsuxei32.v",
        	    "vsse8.v", "vsse16.v", "vsse32.v",
        	    "vsoxei8.v", "vsoxei16.v", "vsoxei32.v",
        	    "vs1r.v", "vs2r.v", "vs4r.v", "vs8r.v"
        ],
            "imm computes": [
	            "vadd.vi", "vrsub.vi", "vand.vi", "vor.vi", "vxor.vi",
        	    "vrgather.vi", "vslideup.vi", "vslidedown.vi",
        	    "vsaddu.vi", "vsadd.vi", "vsll.vi", "vsrl.vi", "vsra.vi",
        	    "vssrl.vi", "vssra.vi", "vnsrl.wi", "vnsra.wi", "vnclipu.wi", "vnclip.wi"
        ],
            "imm shifts": [],
            "reg computes": [
	            "vadd.vv", "vsub.vv", "vminu.vv", "vmin.vv", "vmaxu.vv", "vmax.vv",
        	    "vand.vv", "vor.vv", "vxor.vv", "vrgather.vv", "vslideup.vx", "vslidedown.vx",
        	    "vrgatherei16.vv", "vdivu.vv", "vdiv.vv", "vremu.vv", "vrem.vv", "vmulhu.vv",
        	    "vmul.vv", "vmulhsu.vv", "vmulh.vv", "vwaddu.vv", "vwadd.vv", "vwsubu.vv",
        	    "vwsub.vv", "vwmulu.vv", "vwmulsu.vv", "vwmul.vv", "vmandn.mm", "vmand.mm",
        	    "vmor.mm", "vmxor.mm", "vmorn.mm", "vmnand.mm", "vmnor.mm", "vmxnor.mm",
        	    "vredsum.vs", "vredand.vs", "vredor.vs", "vredxor.vs", "vredminu.vs", "vredmin.vs",
        	    "vredmaxu.vs", "vredmax.vs"
        ],
            "reg shifts": [
 	           "vsll.vv", "vsrl.vv", "vsra.vv", "vssrl.vv", "vssra.vv", "vnsrl.wv", "vnsra.wv",
            ...
            "moves": [
	            "vmv.v.v", "vmv.v.x", "vmv.v.i", "vmerge.vvm", "vmerge.vxm", "vmerge.vim",
	            "vslide1up.vx", "vslide1down.vx", "vcompress.vm"
        ],
            "classifies": [],
            "csrs": [
   ...
   "Zba": {
    ...
    "Zbb": {
            ...
            "reg computes": [
                "andn", "orn", "xnor", "clz", "ctz", "cpop", "max", "maxu", "min", "minu", "rol", "ror"
        ],
            "reg shifts": [],
            "jumps": [],
            "branches": [],
            "compares": [],
            "conversions": [
                "sext.b", "sext.h", "zext.h.rv32", "rev8.rv32"
        ],
            "moves": [],
            "classifies": [],
            "csrs": [],
